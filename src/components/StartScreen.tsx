    ...
    <>
      <div className="min-h-screen bg-background flex flex-col">
        <div className="border-b-4 bg-muted backdrop-blur">
          ...
          {currentUser && (
            <>
              <ProfileAvatar className="absolute left-1/2 -translate-x-1/2 top-[8rem] md:left-4 md:translate-x-0 md:top-[5.5rem] lg:top-24 h-20 w-20 md:h-14 md:w-14" size="lg" />
