    ...
    <>
      <div className="min-h-screen bg-background flex flex-col">
        <div className="border-b-4 bg-muted backdrop-blur">
          ...
          {currentUser && (
            <>
              <ProfileAvatar className="absolute left-1/2 -translate-x-1/2 top-[8rem] md:left-4 md:translate-x-0 md:top-24" size="md" />
              <div className="absolute right-20 top-4 flex items-center gap-2 text-foreground font-bold text-xl">
        ...
        {currentUser && (
          <Button
            ...
            variant="ghost"
            size="icon"
            className="absolute left-4 top-[5.5rem] md:left-4 md:bottom-4 md:top-auto text-foreground transition-all hover:scale-110 h-12 w-12"
          >
